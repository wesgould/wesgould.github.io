(() => {
  ...
  (function() {
    ...
    index.add(
      {
        id: 0,
        href: "/blog/building-a-workbench/",
        title: "Building a Workbench",
        description: "Doing all of this maintenance on my car recently highlighted that I need a nice worktop/work table. I&rsquo;ve been using my kid&rsquo;s play work bench which has been surprisingly useful but it&rsquo;s also built for a 4 year old. I needed something built for an adult.\nA few years back my dad and I bought a couple of Simpson StrongTies workbench kits. We were going to build some workbenches over a weekend but somehow that never came to pass \u2014 I think we went golfing instead. Fortunately, my mom still had the kit in her garage and let me have it.\n",
        content: "Doing all of this maintenance on my car recently highlighted that I need a nice worktop/work table. I&rsquo;ve been using my kid&rsquo;s play work bench which has been surprisingly useful but it&rsquo;s also built for a 4 year old. I needed something built for an adult.\nA few years back my dad and I bought a couple of Simpson StrongTies workbench kits. We were going to build some workbenches over a weekend but somehow that never came to pass \u2014 I think we went golfing instead. Fortunately, my mom still had the kit in her garage and let me have it.\nIt comes with all of the hardware; I just needed to buy the wood.\nSo I brought my apprentice with me: Using the subaru as a truck: Then, ironically, used the kid&rsquo;s workbench to make the cuts: Pics of all of the cut pieces: I assembled it under close supervision: My apprentice inspecting the fine craftsmanship: After that I made pretty rapid progress:\nI got super cocky after making rapid progress and cut the leg space for the lower shelf in the wrong orientation: It&rsquo;s not a huge deal because it&rsquo;s a workbench but I did have to convince myself to not go back to the store and get another piece to fix it.\nBuild complete! I made sure to sink the screws below the surface so I would have a flat smooth work surface. One of the best features of this workbench is the ability to move it around. I want to be able to move it around my carport, down the driveway, onto my back patio&hellip;generally just be able to easily move it to where I want to work. I found some cheap casters on Amazon:\nCasters on Amazon\nHere they are installed: Then I put a couple coats of polyurethane since I plan on using this for various projects that will probably include using cleaners/solvents/oil. "
      }
    ).add(
      {
        id: 1,
    ...
    ).add(
      {
        ...
        content: " This is one of the easiest DIY maintenance things you can do your Subaru. I believe the dealership wanted to charge me $495 to do it. To DIY its about ~$40 in OEM coolant (from the dealership) and $30 in parts/tools. You could probably get by without the special funnel but it makes &lsquo;bleeding&rsquo; the system more straightforward.\nLike the CVT Fluid change, I did a lot of research and consolidated it into a list of steps then had ChatGPT organize it into a printable procedure PDF.\nCoolant flush instructions that I followed\nTools and Supplies\nItem Notes Subaru Super Coolant premix 3 gallons Subaru Cooling System Conditioner 1 bottle Radiator drain plug O-ring If replacing Spill-free coolant funnel kit Large drain pan Rags / paper towels Flat or Phillips screwdriver For splash shield clips as needed 10mm socket For undertray / access panels as needed Pliers For hose clamps if pulling a hose instead of using the radiator drain Jack, jack stands, or ramps Wheel chocks Gloves and eye protection Specs\nCoolant type Subaru Super Coolant premixed (blue) System capacity ~7.4 qt Supplies# This service really only requires the coolant. All my research pointed me towards: &ldquo;Only use OEM Subaru Super Coolant premix.&rdquo; I&rsquo;m not sure how much it actually matters but its pretty cheap and with the amount I am saving doing it myself, I might as well use quality OEM coolant.\nAnother thing to note is that the Subaru dealership parts guy said I&rsquo;d only need 2 (gallon) jugs of coolant and I wouldn&rsquo;t use up the 2nd one. (He was right!)\nI didnt end up getting the coolant conditioner. Based on my research it was recommended for the generations with headgasket issues, but no official Subaru service bulletin recommended or recall required it for my generation or model of engine.\nWhile technically optional, I highly recommend the Harbor Freight No-Spill Radiator funnel kit https://www.harborfreight.com/no-spill-radiator-funnel-kit-58423.html . I&rsquo;ve only ever done it with this kit, but I can&rsquo;t imagine doing it without. It seems like it would be much messier and take longer.\nDraining the Old Coolant# You want to jack up the front of your car or put it on ramps to get to the drain. It also helps bleed the air later when you refill.\nI&rsquo;d make a terrible influence because I didn&rsquo;t get enough pictures of the process but the drain plug is dead simple to get to once you take off the plastic shielding&ndash;which is held on my a dozen plastic plugs and a handful of 10mm bolts.\nThe drain plug is literally a hand tight plastic piece that you can unscrew by hand (and reinstall by hand when you are done. It takes a few minutes to full drain. While this is happening, most people recommend taking off the resevoir and cleaning it out. So thats what I did. Again, no pictures of this process because I&rsquo;m bad at making content. Its easy to take off though. One 10mm bolt and it basically sits in a slot that you have to wiggle to get it out.\nFlushing# So, I didn&rsquo;t have time or inclination to &ldquo;flush&rdquo; the system. There was no real reason I had to flush it. There was no contamination, it never over heated, etc. Since this was for general maintenance purposes I just drained and refilled.\nRefill# Refilling was super easy with the no-spill funnel. You just attach it and fill it up. Once it &ldquo;settles&rdquo; you start the car and let it bleed the air out. You ideally want two cycles of the thermostat so it can take some time.\nIf the coolant gets low in the funnel, refill it.\nIt bubbles quite a bit at first then slows down. It helps if you get the top radiator hose a slight squeeze every so often to help move air out.\nAs you can see, I got the engine up to temp. Note how long it was running though. The whole service was super straightforward but it took an hour an a half mostly because the engine took so long to heat up.\nOnce its stopped bubbling you will have a bit of coolant in the funnel. Take it off, and pour it into the resevoir until it reads &ldquo;Full&rdquo;.\nWrap-Up# I poured the old coolant back into some old 1 gallon water jugs I had and took them to a local auto parts store to dump (most do it for free).\nThats it. I took it on a test drive up the George Washington Parkway and monitored the temps. Everything looked good!\n"
      }
    ).add(
      {
        id: 6,
        ...
        content: "One of the first &lsquo;big&rsquo; maintenance items I decided to tackle as part of my 88k maintenance adventure was the CVT transmission fluid flush. I did tons of research and watched a handful of youtube videos. Its a pretty straightforward process. I wrote up the procedure, as I understood it from all of my research, then had ChatGPT verify it and format it for me and put it into a guide I could follow.\nCVT fluid change instructions that I followed\nTools and Supplies\nItem Notes Subaru CVTF-II 7 qt CVT drain plug washer Part # 803916010 Filler plug gasket Part # 803918060 Fluid transfer pump Graduated drain pan 14mm socket For drain plug 8mm hex bit socket For filler plug Torque wrench Ratchet and extensions Jack, jack stands, or ramps Wheel chocks OBD scanner (CVT temp capable) Needs to read CVT fluid temp Gloves, rags, eye protection Specs\nCVT fluid Subaru CVTF-II Total capacity 12.0 US qt Drain-and-fill amount ~7 qt Final level temp window 35\u201345\xB0C (95\u2013113\xB0F) Torque Values\nComponent Torque CVT drain plug 31 N\xB7m / 22.9 ft-lb CVT filler plug 50 N\xB7m / 36.9 ft-lb Supplies# I had to delay for a weekend because I needed to order a couple tools and the supplies I needed. Based on my research using OEM Subaru CVT-II fluid is recommended. Apparently the Subaru CVT is sensitive to the fluid and using non-OEM can have mixed results. I will say, Idemitsu, the OEM manufacturer of Subaru&rsquo;s CVT fluid, has their that is allegedly the same exact fluid (or better)for ~$13/quart vs the $16 I paid at my local Subaru dealership for the OEM fluid.\nI decided to spend a couple extra bucks and go with the OEM fluid. If I had to do this maintenance more often I might be more price sensitive but since I may only have to do this 1 possibly two more for this car, I figured OEM is worth the &lsquo;premium&rsquo;.\nI also bought a torque wrench, a pump/hose to pump the fluid into the fill hole, and some hex bits since my tool kit didn&rsquo;t have the sizes I needed.\nGetting the Car Up# Like any DIY project, I spent way too much time just getting ready to even start. I had to clean off my ramps that I&rsquo;d left in the elements near my shed. They were covered in dirt/muck and came complete with an entire ant colony that I had to spray off.\nI got to spend the rest of the project with ants wandering around the ground where I was laying. Cool!\nI got the car jacked up and leveled out. It doesn&rsquo;t need to be laser leveled but it should be roughly level so your fluid readings are as accurate as possible.\nThe picture makes it seem less level than it was. Always use jack stands!\nUnder the Car \u2014 and the Issue# I crawled under the car and immediately noticed a problem with the CVT.\nThe CVT drain pan looked &ldquo;wet&rdquo; and when I looked at the bolt it was clearly leaking. When I say leaking I mean, it was noticeably wet and dripping fluid. The ONLY way this happened is if the dealership tech either:\naccidentally opened it while I was getting my oil changed the 2 weeks prior did the CVT service instead of the diffs (and did it poorly). So I was a little annoyed.\nI decided, with the amount of fluid it looked like it was leaking, and since I was already planning on doing the service, that I would just finish. Then I&rsquo;d take it to the dealership to have it documented and make them confirm they did the diffs that I paid for. The cause of the leak: a missing crush washer. And the drain plug was pristine. There is no way in hell this should be pristine unless someone recently wiped it clean&hellip; Drain# Refill# Getting to Temperature# Meanwhile, Back from the dealership&hellip;# I got it buttoned up and went to the dealership to make them verify my diffs were done properly. I didn&rsquo;t have a ton of faith that the service I paid for was completed. I thought maybe they did the CVT (poorly) instead?\nThey put it on the lift and showed me the diffs were done. They were annoyingly skeptical of my leaking CVT story even with the videos. But all in all they were pretty cool about it.\nThey didn\u2019t admit to anything and they were skeptical that maybe I screwed something up. I&rsquo;m sure they&rsquo;ve heard wild stuff from shady customers so I dont really blame them for being wary. But I showed them the video and they looked at my service history. When they looked it up and realized that I always brought it to them for everything and I was just in 2 weeks ago for service they softened a bit. The service manager is going to have them check the CVT level next time I come in for a service. My transmission was too hot for them to do anything about it today and I didn&rsquo;t want to wait 4 hours for it to cool down. (Hilariously), they seem worried that I didn&rsquo;t do the service properly.\nThey are putting a note in my file to do it next time I come in when I can leave it for longer.\nThey also tried to go back and look through the videos and photos that they take during their inspections (the grainy ass ones they text you) to see if they could see it dripping. The service manager said the techs would\u2019ve said something if they saw it. They also told me that the tech that did the last work on my car is a pretty seasoned tech, that they don\u2019t have issues with, so they\u2019re pretty sure he wasn\u2019t the one to have done that. My response to that was, the tech that&rsquo;s on the paperwork might not be the tech that did my diff service. I am sure you dont have a senior tech doing oil changes so whoever was doing the oil changes that day probably screwed up and started to drain the cvt, panicked, put back the bolt (without the washer), and screwed it in. The shop foreman asked me if I&rsquo;d seen any stains on the ground in my driveway and I said &ldquo;No, I dont think I have&rdquo;.\nThe conversation got to a point where I just said, &ldquo;Look, I know I didn\u2019t do it. You don\u2019t have any reason to think that your guys did it. I just want it documented in my file that this happened so that if anything comes up down-the-road with this transmission, we can fight about it then.&rdquo; and they all laughed. Part of this blog is to document it for posterity on my end.\nGotta say they got it up on that lift and did all that stuff so much faster than I did with those ramps and the jacks.\nWhen I got home I looked at my driveway and realized there were actually quite a bit of stains on it from CVT fluid. I guess my brain never registered them as more than &ldquo;AC condensation drips&rdquo;.\nAt the rate it was dripping when I crawled underneath and the amount of staining I had, there is no way this DIDNT happen at my previous service. IF it happened 2+ weeks before, my CVT would have run low on fluid and grenaded well beforehand.\nSo in a twist of fate, this wild hair I got to work on my own car caught this pretty serious issue before anything major happened.\n"
      }
    ).add(
      {
        id: 7,
